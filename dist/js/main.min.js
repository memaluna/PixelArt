!(function () {
  ...
  function a() {
    ...
    i.checked
      ? (n.classList.remove("lights-off"), localStorage.setItem("dark", false), e && (e.innerHTML = "oscuro"))
      : (n.classList.add("lights-off"), localStorage.setItem("dark", true), e && (e.innerHTML = "claro"));
